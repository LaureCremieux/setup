...
git config --global user.name "Laure Cremieux"
git config --global user.email "laure.cremieux@gmail.com"
ssh-keygen -t rsa -N "" -C "laure.cremieux@gmail.com" -f ~/.ssh/id_rsa
ssh-add .ssh/id_rsa
